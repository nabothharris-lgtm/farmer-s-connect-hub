...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — AgriConnect Free vs Pro" },
      { name: "description", content: "Compare Free and Pro plans. Upgrade to get promoted placement and marketplace ads." },
      { property: "og:title", content: "Pricing — AgriConnect" },
      { property: "og:description", content: "Free vs Pro plans for farmers, experts, stores and agents in Uganda." },
    ],
  }),
